...
// 1) positionBuffer
// 2) colorBuffer
Shader "Instanced Shaders/Instanced Surface-Positional" {
	Properties
	{
	...
	//========== UNIFORMS ==========//
		...
		//========== PER INSTANCE SETUP ==========//
			...
			//========== PER-INSTANCE SURFACE SHADING ==========//
				...
				{
					#ifdef UNITY_PROCEDURAL_INSTANCING_ENABLED
						o.Albedo = _Color * _EmissionColor;				// _colorBuffer[unity_InstanceID].rgb;
						o.Emission = _Color   ; // * _colorBuffer[unity_InstanceID].rgb;
					#endif
